...
public class Lucene101ForUtil {
    ...
    static void expand8(int[] arr) {
        // Copied from DefaultVectorUtilSupport
        for (int i = 0; i < 64; ++i) {
            int l = arr[i];
            arr[i] = (l >>> 24) & 0xFF;
            arr[64 + i] = (l >>> 16) & 0xFF;
    ...
    static void decodeSlow(int bitsPerValue, Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    void decode(int bitsPerValue, Lucene101PostingDecodingUtil pdu, int[] ints) throws IOException {
        switch (bitsPerValue) {
            case 1:
                decode1(pdu, ints);
                expand8(ints);
    ...
    static void decode1(Lucene101PostingDecodingUtil pdu, int[] ints) throws IOException {
        pdu.splitInts(8, ints, 7, 1, MASK8_1, ints, 56, MASK8_1);
    }

    static void decode2(Lucene101PostingDecodingUtil pdu, int[] ints) throws IOException {
        pdu.splitInts(16, ints, 6, 2, MASK8_2, ints, 48, MASK8_2);
    }

    static void decode3(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode4(Lucene101PostingDecodingUtil pdu, int[] ints) throws IOException {
        pdu.splitInts(32, ints, 4, 4, MASK8_4, ints, 32, MASK8_4);
    }

    static void decode5(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode6(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode7(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode8(Lucene101PostingDecodingUtil pdu, int[] ints) throws IOException {
        pdu.in.readInts(ints, 0, 64);
    }

    static void decode9(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode10(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode11(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode12(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode13(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode14(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode15(Lucene101PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    ...
    static void decode16(Lucene101PostingDecodingUtil pdu, int[] ints) throws IOException {

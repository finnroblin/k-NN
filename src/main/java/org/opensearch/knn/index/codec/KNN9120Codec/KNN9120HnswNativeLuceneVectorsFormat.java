...
public final class KNN9120HnswNativeLuceneVectorsFormat extends KnnVectorsFormat {
     ...
     */
    public KNN9120HnswNativeLuceneVectorsFormat() {
     ...
     */
    public KNN9120HnswNativeLuceneVectorsFormat(int maxConn, int beamWidth) {
     ...
     */
    public KNN9120HnswNativeLuceneVectorsFormat(int maxConn, int beamWidth, int numMergeWorkers, ExecutorService mergeExec) {
        super(NAME);
